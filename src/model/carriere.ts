...
const PROLOGUE: Etape[] = [
  ...
  },
  {
    ...
    lignes: [
      ...
      'SOL: Je vais vendre.',
      'TOI: Alors pourquoi on travaille encore ?',
   ...
   * premier exercice. */
  {
    ...
    lignes: [
      ...
      'SOL: Il va falloir tout refaire.',
      ...
      'SOL: Approche. Écoute, et tape avec.',
    ],
  },
];
...
export const ACTES: Acte[] = [
  {
    ...
    etapes: [
       ...
       * maintenant montrer ce qu'on n'entend PAS. */
      {
        kind: 'exercice',
        niveau: 64,
        /* ⚠️ D'UNE SEULE VOIX depuis que les répliques portent leur nom
         * (`model/locuteurs.ts`). Ce brief tenait trois répliques et deux
         * personnes sur une ligne — « — Tu fais quoi exactement ici ? — Le
         * café. — Je sais. » — donc rien ne pouvait dire qui parlait. Une
         * consigne est UNE ligne (voir `EtapeExercice.commande`) : le
         * dialogue, lui, a ses écrans. */
        commande: 'SOL: Tu fais quoi exactement ici ? Le café, je sais. Écoute ça, et tape avec.',
      },
      {
        kind: 'recit',
        source: 'fax',
        ...
        lignes: [
          ...
          'SOL: Sur les trois euros,',
          'SOL: il nous en revient onze centimes.',
          'TOI: C’est peu.',
          'SOL: C’est onze centimes de plus qu’un album.',
        ],
      },
      {
        kind: 'exercice',
        niveau: 65,
        commande: 'SOL: Recommence. Il y a un coup de plus, et il ne tombe pas sur un temps.',
      },
       ...
       * papier : quand l'Atelier s'ouvrira, il saura déjà ce qu'il regarde. */
      {
        ...
        lignes: [
          ...
          'SOL: C’est comme ça qu’on les écrit.',
          'TOI: Et on les lit comment ?',
          'SOL: Comme ça.',
      ...
      },
      {
        kind: 'exercice',
        niveau: 66,
        commande: 'SOL: Là je coupe le son du kick. Tu l’as sous les yeux : joue-le.',
      },
      {
        kind: 'recit',
        source: 'lcd',
        ...
        lignes: [
          ...
          'SOL: Lundi tu fais les sonneries.',
          'SOL: Encore une chose.',
        ],
      },
      {
        kind: 'exercice',
        niveau: 52,
        commande: 'SOL: Ce qu’on n’entend pas compte autant. Où est le trou ?',
      },
      {
        kind: 'recit',
        source: 'fax',
        ...
        lignes: [
          ...
          'SOL: Voilà. Tu es officiellement',
          'SOL: dans l’industrie musicale.',
        ],
      },
    ],
  },
    ...
    etapes: [
       ...
       * dans l'écran d'à côté n'a pas besoin du sien. */
      {
        ...
        lignes: [
          ...
          'SOL: Ça veut dire qu’ils ne savent pas.',
          'Sol pose trois mots sur la table :',
          'Kick. Snare. Hi-hat.',
          'SOL: Le reste, c’est de la décoration.',
        ],
      },
       ...
       * fait, à l'écran, avant qu'on les demande. */
      {
        ...
        lignes: [
          ...
          'SOL: Deux gestes. C’est tout ce qui sépare',
          'SOL: une sonnerie d’un réveille-matin.',
        ],
      },
      ...
      { kind: 'exercice', niveau: 61, commande: 'Le dernier. Tout ce que tu sais, dans une mesure — et rien au singulier.' },
      {
        ...
        lignes: [
          ...
          'SOL: On était meilleurs quand on vendait des albums.',
          'TOI: Vous avez arrêté pourquoi ?',
          'SOL: Nous, on n’a pas arrêté.',
          'SOL: Les gens ont arrêté d’acheter.',
        ],
      },
       ...
       * moment. */
      {
        ...
        lignes: [
          ...
          'SOL: La dernière, elle est à toi. Emporte-la.',
          ...
          'SOL: Et le lundi matin, tu penseras à nous.',
        ],
    ...
    etapes: [
       ...
       * règle. Voir `parametres.ts`. */
      {
        ...
        lignes: [
          ...
          'KELVIN: C’est nul.',
          'TOI: Pourquoi ?',
          'KELVIN: Ça fait réveil.',
          'Il tape du doigt sur la table, à côté du temps.',
          'KELVIN: C’est carré. Personne ne danse carré.',
        ],
      },
       ...
       * `lequel` d'écoute sont partis. */
      {
        ...
        lignes: [
          ...
          'SOL: Il a raison.',
          'SOL: Ça s’appelle le swing.',
          'SOL: Un temps sur deux arrive un peu en retard.',
          'SOL: Toujours le même, toujours du même retard.',
          'TOI: Et c’est réglable ?',
          'SOL: Tout est réglable. C’est bien le problème.',
        ],
      },
      ...
      },
      {
        ...
        lignes: [
          ...
          'KELVIN: Comme ça.',
          'TOI: Ça fait combien, « comme ça » ?',
          'KELVIN: J’en sais rien. Comme ça.',
          'SOL: Il y en a un autre. Là, c’est la ligne entière qui glisse.',
          'SOL: Le kick, lui, ne bouge pas. C’est contre lui qu’on l’entend.',
        ],
      },
      {
        kind: 'exercice',
       ...
       * l'idée. */
      {
        ...
        entete: 'SOL',
        lignes: [
          'SOL: Il reste un truc, et c’est celui qu’on n’écrit pas.',
          'SOL: La machine peut jouer à côté toute seule :',
          'SOL: des coups en plus, ou pas toujours la même force.',
          'SOL: Ghost notes, vélocité, rafales. Trois boutons.',
          'SOL: C’est ce qui sépare une boîte à rythmes d’un batteur.',
          'SOL: Et ça, tu ne le reconnaîtras qu’en l’ayant mis toi-même.',
        ],
      },
      ...
      },
      {
        ...
        accepte: 'KELVIN: Là. Ça respire. Tu vois quand tu veux.',
        titre: 'SANS TITRE',
        client: 'KELVIN',
      },
      {
    ...
    etapes: [
      ...
      },
      {
        ...
        lignes: [
          ...
          'RACHID: Ça, ça fait dentiste.',
          'RACHID: Ça, ça fait linge sale.',
          'RACHID: Ça fait linge propre chez quelqu’un d’autre.',
          'TOI: Et tu veux quoi ?',
          'RACHID: Quelque chose qui donne envie de rentrer chez soi.',
        ],
      },
      {
        kind: 'exercice',
       ...
       * parce que c'est lui qui écoute et qui paie. */
      {
        ...
        lignes: [
          ...
          'RACHID: C’est bien.',
          'TOI: Mais ?',
          'RACHID: Au bout de trois fois, je sais ce qui vient.',
          'Il cherche ses mots.',
          'RACHID: Ça fait sonnerie. Je veux un morceau.',
          'Sol, sans lever les yeux :',
          'SOL: Alors laisse-la finir sa phrase.',
          'SOL: Une boucle d’une mesure revient toujours au même endroit.',
          'SOL: Une phrase de deux mesures a le temps de répondre.',
        ],
      },
      {
        kind: 'exercice',
       ...
       * l'essai, ce que l'Atelier n'a pas à faire. */
      {
        ...
        lignes: [
          'RACHID: C’est combien ?',
          'TOI: Vous voulez quoi, exactement ?',
          'RACHID: Ce que j’ai entendu dans l’escalier.',
        ...
        accepte: 'RACHID: Ça. Je sais pas pourquoi. C’est combien ?',
      ...
      },
      {
        ...
        entete: 'SOL',
        lignes: [
          'SOL: Il l’a prise. Elle est maigre.',
          'TOI: Elle lui plaît.',
          'SOL: Elle plaira moins la deux-centième fois.',
          'Elle pose un doigt sous la ligne.',
          'SOL: Une mélodie toute seule, c’est un sifflement.',
          'SOL: Mets ce qu’il y a dessous. La basse ne rejoue pas la mélodie :',
          'SOL: elle la porte. Moins de notes, et le premier temps.',
        ],
      },
      {
        kind: 'commande',
        ...
        lignes: [
          ...
          'RACHID: Dans la machine, on n’entend que le haut.',
          'RACHID: Il faut que ça descende.',
        ...
        accepte: 'RACHID: Là on l’entend depuis le fond du magasin.',
      ...
      },
      {
        ...
        entete: 'SOL',
        lignes: [
          'SOL: C’est juste. C’est nu.',
          'Elle ouvre la troisième ligne.',
          'SOL: La nappe, c’est ce qu’il y a derrière.',
          'SOL: On ne l’écoute jamais. On la remarque quand elle part.',
          'SOL: Et elle ne reste pas un bloc : elle bouge, un peu.',
          'SOL: Dernière chose : arrête de tout laisser sur la voix d’usine.',
          'SOL: Une note, ce n’est pas un son. Choisis-lui un son.',
        ],
      },
      {
        kind: 'commande',
        ...
        lignes: [
          ...
          'RACHID: Il va tourner huit heures par jour.',
          'RACHID: Il faut qu’on le supporte encore le soir.',
    ...
    etapes: [
      ...
      },
      {
        ...
        lignes: [
          ...
          'SOL: Enlève ce qui ne sert pas.',
          'SOL: Et mets une basse qui existe encore à la laverie.',
        ],
        bouton: 'Ouvrir l’Atelier ▸',
      ...
      },
      {
        ...
        lignes: [
          ...
          'Sol rappelle.',
          'LE TUNNEL: Le morceau est bien.',
          'SOL: Alors pourquoi vous ne le gardez pas ?',
          'LE TUNNEL: Parce que personne ne bouge.',
          'Elle raccroche. Elle débranche le haut-parleur',
          'de la laverie et le pose sur la table.',
          'SOL: Écoute le tien là-dedans.',
        ],
      },
      {
        kind: 'recit',
        ...
        entete: 'SOL',
        lignes: [
          'SOL: Tu entends ? Tout le grave est parti.',
          'SOL: Et les trois lignes sonnent au même endroit.',
          'SOL: Ton morceau est bon dans ton ordinateur.',
          'Elle tapote le petit boîtier.',
          'SOL: Ici, il est mauvais. Et c’est ici qu’on l’écoute.',
          'TOI: Je fais quoi ?',
          'SOL: Tu enlèves, et tu ranges. Ajouter, c’est après.',
        ],
      },
      {
        kind: 'commande',
        ...
        lignes: [
          ...
          'SOL: Enlève ce qui traîne en haut.',
          'SOL: Et arrête de tout mettre au même volume :',
          'SOL: trois cents personnes ne dansent pas sur une bouillie.',
        ],
      ...
      },
      {
        ...
        entete: 'SOL',
        lignes: [
          'SOL: C’est propre. C’est plat.',
          'TOI: Tu m’as dit d’enlever.',
          'SOL: Je t’ai dit d’enlever D’ABORD.',
          'Elle pousse deux curseurs, l’un après l’autre.',
          'SOL: La réverbe éloigne. Le delay répète.',
          'SOL: On les confond tout le temps, et ce sont deux pièces différentes.',
          'SOL: Maintenant tu ajoutes. Un peu.',
        ],
      },
      {
        kind: 'commande',
        ...
        lignes: [
          ...
          'SOL: De l’espace, mais pas une cathédrale.',
          'SOL: Un delay qui répond, pas qui bave.',
          'SOL: Et je veux que tu aies regardé chaque ligne.',
        ],
        bouton: 'Reprendre le morceau ▸',
        modulesRequis: ['production'],
        partirDeLaLivraison: true,
      ...
      },
      {
        ...
        lignes: [
          ...
          'Le lundi, ils paient.',
          'SOL: Première fois depuis 1998 qu’un morceau de Face B',
          'SOL: fait danser quelqu’un.',
    ...
    etapes: [
      ...
      },
      {
        ...
        lignes: [
          ...
          'SOL: Ils sont bons.',
          'TOI: Alors c’est bien ?',
          'SOL: Oui. C’est justement le problème.',
        ],
      },
      {
        kind: 'recit',
        ...
        entete: 'SOL',
        lignes: [
          'SOL: On faisait des disques.',
          'Elle montre les quinze sonneries.',
          'SOL: Maintenant on fabrique des choses',
          'SOL: que les gens oublient avant la prochaine sonnerie.',
  ...
  },
  {
    ...
    etapes: [
       ...
       * bouton qui ne juge rien — ce que le joueur sent au premier clic. */
      {
        ...
        entete: 'LE TIROIR',
        lignes: [
          'TOI: Maintenant qu’on a de l’argent, pourquoi tu vends ?',
          'SOL: Parce que je ne veux pas passer dix ans de plus',
          'SOL: à fabriquer des sonneries.',
      ...
      },
      {
        ...
        lignes: [
          'SOL: Ce numéro devait être celui d’Ambre.',
          'Un silence.',
          'SOL: Je voudrais qu’il soit le tien.',
          'SOL: Je vends quand même. Mais je ne pars pas',
          'SOL: sans avoir sorti ce numéro.',
      ...
      },
      {
        ...
        lignes: [
          ...
          'SOL: Il me faut un nom. Pour le catalogue.',
...
export const EPILOGUE: EtapeRecit[] = [
   ...
   * repose entièrement sur ce que le joueur ENTEND depuis l'autre pièce. */
  {
    ...
    lignes: [
      ...
      'SOL: Elle fuit quand tu remplis trop.',
      'Puis elle lance une boucle, quatre coups, rien d’autre.',
      'SOL: Écoute ça, et tape avec.',
  ...
  },
  {
    ...
    lignes: [
      ...
      'SOL: Lundi, tu fais les sonneries.',
      'LE STAGIAIRE: Et sinon, je fais quoi ?',
