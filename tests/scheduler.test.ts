...
// ⚠️ Le harnais de rejeu vit dans `tests/helpers/rejeu.ts` depuis qu'un second
// fichier en a besoin — une seule définition, alignée sur `renderPattern`.
import { renderEvents, type Ev } from './helpers/rejeu';
